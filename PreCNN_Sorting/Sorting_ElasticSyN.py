...
for i in AD:
  shutil.move('/Output_ants_ElasticSyN/Greymatter/' + i + '.nii', '/Output_ants_ElasticSyN/AD/')
  continue;

for i in CN:
  shutil.move('/Output_ants_ElasticSyN/Greymatter/' + i + '.nii', '/Output_ants_ElasticSyN/CN/')
  continue;

for i in MCI:
  shutil.move('/Output_ants_ElasticSyN/Greymatter/' + i + '.nii', '/Output_ants_ElasticSyN/MCI/')
  continue;
