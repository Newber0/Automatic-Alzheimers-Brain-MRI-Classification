...
datapath = ('/arc/project/ex-rtam-1/Output_ants_Translation/DataSamples/ADvsMCI/')
...
plt.savefig('/scratch/ex-rtam-1/Translation/TranslationADvsMCIAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/Translation/TranslationADvsMCILoss.pdf')
