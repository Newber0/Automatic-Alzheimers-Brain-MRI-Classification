...
datapath = ('/Output_ants_Translation/DataSamples/ADvsMCI/')
...
plt.savefig('/Translation/TranslationADvsMCIAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/Translation/TranslationADvsMCILoss.pdf')
