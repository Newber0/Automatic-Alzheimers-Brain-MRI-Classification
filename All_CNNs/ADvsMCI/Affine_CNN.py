...
datapath = ('/arc/project/ex-rtam-1/Output_ants_Affine/DataSamples/ADvsMCI/')
...
X_train, X_valid, y_train, y_valid = train_test_split(FullDataSet, labelset, train_size=0.75, random_state=42 )
...
plt.savefig('/scratch/ex-rtam-1/Affine/AffineADvsMCIAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/Affine/AffineADvsMCILoss.pdf')
