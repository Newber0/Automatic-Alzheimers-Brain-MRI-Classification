...
datapath = ('/arc/project/ex-rtam-1/Output_ants_SyNAggro/DataSamples/ADvsMCI/')
...
plt.savefig('/scratch/ex-rtam-1/SyNAggro/SyNAggroADvsMCIAcc2.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/SyNAggro/SyNAggroADvsMCILoss2.pdf')
