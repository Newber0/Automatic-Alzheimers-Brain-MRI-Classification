...
datapath = ('/arc/project/ex-rtam-1/Output_ants_ElasticSyN/DataSamples/MCIvsCN/')
...
plt.savefig('/scratch/ex-rtam-1/ElasticSyN/ElasticSyNMCIvsCNAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/ElasticSyN/ElasticSyNMCIvsCNLoss.pdf')
