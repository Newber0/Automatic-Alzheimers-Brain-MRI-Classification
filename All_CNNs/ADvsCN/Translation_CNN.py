...
datapath = ('/arc/project/ex-rtam-1/Output_ants_Translation/DataSamples/ADvsCN/')
...
plt.savefig('/scratch/ex-rtam-1/Translation/TranslationADvsCNAcc2.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/Translation/TranslationADvsCNLoss2.pdf')
...
#model.save('/scratch/ex-rtam-1/Translation/TranslationADvsCNModel.h5')