...
datapath = ('/Output_ants_Translation/DataSamples/ADvsCN/')
...
plt.savefig('/Translation/TranslationADvsCNAcc2.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/Translation/TranslationADvsCNLoss2.pdf')
