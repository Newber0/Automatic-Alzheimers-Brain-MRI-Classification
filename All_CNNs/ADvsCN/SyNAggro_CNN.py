...
datapath = ('/arc/project/ex-rtam-1/Output_ants_SyNAggro/DataSamples/ADvsCN/')
...
plt.savefig('/scratch/ex-rtam-1/SyNAggro/SyNAggroADvsCNAcc2.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/SyNAggro/SyNAggroADvsCNLoss2.pdf')
...
#model.save('/scratch/ex-rtam-1/SyNAggro/SyNAggroADvsCNModel.h5')