...
datapath = ('/arc/project/ex-rtam-1/Output_ants_Translation/DataSamples/MCIvsCN/')
...
plt.savefig('/scratch/ex-rtam-1/Translation/TranslationMCIvsCNAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/Translation/TranslationMCIvsCNLoss.pdf')
