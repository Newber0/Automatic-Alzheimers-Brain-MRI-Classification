...
datapath = ('/Output_ants_Translation/DataSamples/MCIvsCN/')
...
plt.savefig('/Translation/TranslationMCIvsCNAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/Translation/TranslationMCIvsCNLoss.pdf')
