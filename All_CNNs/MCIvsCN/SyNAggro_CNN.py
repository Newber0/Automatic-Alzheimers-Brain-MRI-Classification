...
datapath = ('/arc/project/ex-rtam-1/Output_ants_SyNAggro/DataSamples/MCIvsCN/')
...
plt.savefig('/scratch/ex-rtam-1/SyNAggro/SyNAggroMCIvsCNAcc2.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/SyNAggro/SyNAggroMCIvsCNLoss2.pdf')
