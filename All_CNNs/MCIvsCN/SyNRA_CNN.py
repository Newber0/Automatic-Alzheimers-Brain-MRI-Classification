...
datapath = ('/arc/project/ex-rtam-1/Output_ants_SyNRA/DataSamples/MCIvsCN/')
...
plt.savefig('/scratch/ex-rtam-1/SyNRA/SyNRAMCIvsCNAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/SyNRA/SyNRAMCIvsCNLoss.pdf')
