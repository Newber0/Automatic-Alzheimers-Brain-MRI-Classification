...
datapath = ('/arc/project/ex-rtam-1/Output_ants_Affine/DataSamples/MCIvsCN/')
...
plt.savefig('/scratch/ex-rtam-1/Affine/AffineMCIvsCNAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/Affine/AffineMCIvsCNLoss.pdf')
