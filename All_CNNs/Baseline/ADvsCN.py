...
datapath = ('/scratch/ex-rtam-1/original/ADvsCN/')
...
plt.savefig('/scratch/ex-rtam-1/Baseline/BaselineADvsCNAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/Baseline/BaselineADvsCNLoss.pdf')
