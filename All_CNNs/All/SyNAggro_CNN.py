...
datapath = ('/arc/project/ex-rtam-1/Output_ants_SyNAggro/DataSamples/All/')
...
plt.savefig('/scratch/ex-rtam-1/SyNAggro/SyNAggroAllAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/SyNAggro/SyNAggroAllLoss.pdf')
...
model.save('/scratch/ex-rtam-1/SyNAggro/SyNAggroAllModel.h5')