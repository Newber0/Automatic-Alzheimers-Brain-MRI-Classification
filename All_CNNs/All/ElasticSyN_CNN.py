...
datapath = ('/arc/project/ex-rtam-1/Output_ants_ElasticSyN/DataSamples/All/')
...
plt.savefig('/scratch/ex-rtam-1/ElasticSyN/ElasticSyNAllAcc.pdf')
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('/scratch/ex-rtam-1/ElasticSyN/ElasticSyNAllLoss.pdf')
...
#model.save('/scratch/ex-rtam-1/ElasticSyN/ElasticSyNAllModel.h5')