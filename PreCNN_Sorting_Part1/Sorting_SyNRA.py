...
for i in AD:
  shutil.move('/Output_ants_SyNRA/Greymatter/' + i + '.nii', '/Output_ants_SyNRA/AD/')
  continue;

for i in CN:
  shutil.move('/Output_ants_SyNRA/Greymatter/' + i + '.nii', '/Output_ants_SyNRA/CN/')
  continue;

for i in MCI:
  shutil.move('/Output_ants_SyNRA/Greymatter/' + i + '.nii', '/Output_ants_SyNRA/MCI/')
  continue;
